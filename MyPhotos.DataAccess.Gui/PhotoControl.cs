...
namespace MyPhotos.DataAccess.Gui
{
    public partial class PhotoControl : Form
    {
        ...
        public PhotoControl()
        {
            ...
            var container = new MyPhotosModelContainer();
            _repository = new PhotoRepository(container);
            _typeRepository = new TypeRepository(container);
            _eventRepository = new EventRepository(container);
            _placeRepository = new PlaceRepository(container);
            _personRepository = new PersonRepository(container);
        }
